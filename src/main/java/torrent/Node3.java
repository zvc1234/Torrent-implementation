...
public class Node3 {
    ...
    static public void main(String args[]) {
        Torrent.NodeId node = Torrent.NodeId.newBuilder().setIndex(3).setPort(6006).setHost("127.0.0.1")
                .setOwner("zasd").build();
        ...
        try{
            ...
            Torrent.Message message = Torrent.Message.newBuilder().setType(Torrent.Message.Type.REGISTRATION_REQUEST).
                    setRegistrationRequest(Torrent.RegistrationRequest.newBuilder().setIndex(3).setPort(6006).setOwner("zasd")
                            .build()).build();
